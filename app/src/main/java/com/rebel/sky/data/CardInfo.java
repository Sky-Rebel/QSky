...
public class CardInfo
{
    ...
    public String toString()
	{
        return "CardInfo[addSrcId="
                ...
                + ", enlargeQzonePic="
                + enlargeQzonePic
                + ", extendFriendEntryAddFriend="
                + extendFriendEntryAddFriend
                + ", extendFriendEntryContact="
                + extendFriendEntryContact
                + ", extendFriendFlag="
                + extendFriendFlag
                + ", extendFriendQuestion="
                + extendFriendQuestion
                + ", extendFriendVoiceDuration="
                + extendFriendVoiceDuration
                + ", favoriteSource="
                + favoriteSource
                + ", feedPreviewTime="
                ...
                + ", iVoteIncrement="
                + iVoteIncrement
                + ", iXManScene1DelayTime="
                + iXManScene1DelayTime
                + ", iXManScene2DelayTime="
                + iXManScene2DelayTime
                + ", idx="
                + idx
                + ", isHidePrettyGroutIdentity="
                + isHidePrettyGroutIdentity
                + ", isPrettyGroupOwner="
                + isPrettyGroupOwner
                + ", isQCircleDynamicAvatar="
                + isQCircleDynamicAvatar
                + ", isShowCard="
                + isShowCard
                + ", isShowQCircleCover="
                ...
                + ", isZPlanAvatar="
                + isZPlanAvatar
                + ", isZPlanProfileCardMiniHomeShow="
                + isZPlanProfileCardMiniHomeShow
                + ", isZplanMasterShow="
                + isZplanMasterShow
                + ", isZplanProfileCardShow="
                + isZplanProfileCardShow
                + ", lBigClubTemplateId="
                + lBigClubTemplateId
                + ", lLoginDays="
                ...
                + ", qcircleFeedId="
                + qcircleFeedId
                + ", qcircleFeedPosterUin="
                + qcircleFeedPosterUin
                + ", qcircleVideoCoverUrl="
                + qcircleVideoCoverUrl
                + ", qcircleVideoHeight="
                + qcircleVideoHeight
                + ", qcircleVideoUrl="
                ...
                + ", strangerVoteOpen="
                + strangerVoteOpen
                + ", svipPrivilegeLimitTime="
                + svipPrivilegeLimitTime
                + ", svipPrivilegeNeedShow="
                + svipPrivilegeNeedShow
                + ", tempChatSig="
                + tempChatSig
                + ", uCurMulType="
                ...
                + ", switchQQCircle="
                + switchQQCircle
                + ", switchLifeAchievement="
                + switchLifeAchievement
                + ", switchWeiShi="
                + switchWeiShi
                + ", switchPrivilege="
                + switchPrivilege
                + ", switchMembershipAndRank="
                + switchMembershipAndRank
                + ", profileDisplaySettingStates="
                + profileDisplaySettingStates
                + ", hasFakeData="
                + hasFakeData
                + ", likeAreaId="
                ...
                + ", bigVipBadgeItemId="
                + bigVipBadgeItemId
                + ", strangerInviteMeGroupOpen="
                + strangerInviteMeGroupOpen
                + ", newSchoolStatusFlagForGuide="
                + newSchoolStatusFlagForGuide
                + ", troopHonorSwitch="
                + troopHonorSwitch
                + ", lhLevel="
