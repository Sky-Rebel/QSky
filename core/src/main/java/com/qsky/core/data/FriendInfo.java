...
public class FriendInfo
{
    ...
    public String toString()
	{
        return "FriendInfo[adCode="
                ...
                + ", area="
                + area
                + ", autoStatusUpdateSecond="
                + autoStatusUpdateSecond
                + ", cSpecialFlag="
                + cSpecialFlag
                + ", city="
                + city
                + ", constellationBgImageUrl="
                + constellationBgImageUrl
                + ", constellationDateStr="
                + constellationDateStr
                + ", constellationIconUrl="
                + constellationIconUrl
                + ", constellationJumpUrl="
                + constellationJumpUrl
                + ", constellationLuckyColor="
                + constellationLuckyColor
                + ", constellationLuckyNumber="
                + constellationLuckyNumber
                + ", constellationTodayTrend="
                + constellationTodayTrend
                + ", constellationTomorrowTrend="
                + constellationTomorrowTrend
                + ", customOnlineStatus="
                + customOnlineStatus
                + ", customOnlineStatusType="
                + customOnlineStatusType
                + ", datetime="
                + datetime
                + ", detalStatusFlag="
